...
-}
tellSign :: Int -> String
tellSign n = if n <= 0 then if n < 0 then "negative" else "zero" else "positive"
...
howManyDigits n = if n < 100 then if n < 10 then "single" else "two-digit" else "three-digit or more"
